...
publications %>%
  ...
  manual_page_break_after_row("ref2print", "Endosymbiotic ratchet accelerates divergence after organelle origin") %>%
  manual_page_break_after_row("ref2print", "Commonly misunderstood parameters of NCBI BLAST and important considerations for users") %>%
  knitr::kable()
```
