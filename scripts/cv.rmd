...
publications %>%
  ...
  #manual_page_break_after_row("ref2print", "implications for reproduction and population dynamics in two sympatric Hawaiian coral") %>%
...
cv_entries %>% 
  ...
  #manual_page_break_after_row("what", "EMBL Australia PostgraduateSymposium 2017") %>%
  kable()
```
