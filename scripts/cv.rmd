...
publications %>%
  ...
  #manual_page_break_after_row("ref2print", "Inferring phylogenomic relationship of microbes using scalable alignment-free methods") %>%
...
cv_entries %>% 
  ...
  select(year, what) %>% 
  manual_page_break_after_row("what", "Duties included guiding undergraduate chemistry students through") %>%
  kable()
```
