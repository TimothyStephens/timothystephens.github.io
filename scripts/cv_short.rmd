...
publications %>%
  ...
  manual_page_break_after_row("ref2print", "Ploidy variation and its implications for reproduction and population dynamics in two sympatric Hawaiian coral species") %>%
