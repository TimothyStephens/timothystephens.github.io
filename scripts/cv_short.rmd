...
| <i class="fas fa-globe"></i> | [timothystephens.com](https://timothystephens.com) |
...
## Professional development {.prof-dev .nohead .set-width-year}
```{r}
cv_entries %>% 
...
## Select Publications {.publications .nohead .set-width-year}
```{r}
publications %>%
  arrange(desc(date)) %>%
